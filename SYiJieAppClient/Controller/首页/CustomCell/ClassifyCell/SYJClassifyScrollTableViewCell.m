//
//  SYJClassifyScrollTableViewCell.m
//  SYiJieAppClient
//
...
@implementation SYJClassifyScrollTableViewCell{
...
- (void) setScrollImage{
    ...
    // 5.设置pageControl的总页数
    self.pageControl.numberOfPages = [ClassifyScrollImagesArray count];
...
-(void) nextImage{
    NSInteger page = 0;
    if (self.pageControl.currentPage == [ClassifyScrollImagesArray count]-1) {
        page = 0;
    }
    else{
